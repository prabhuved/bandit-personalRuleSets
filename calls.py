...
def gen_blacklist():
	...
	# updated security rule sets starts here
	
	#Deprecated method that leads to RCE
    sets.append(utils.build_conf_dict(
        'yaml_load', 'B326',
        ['yaml.load'],
	...
	#Identify potential redirects. Leads to open URL redirects if user input is passed in these methods
    sets.append(utils.build_conf_dict(
	...
	#Check if sensitive information is encoded using Base64
    sets.append(utils.build_conf_dict(
        'Base64_encoding_used', 'B009',
        ['base64.b64encode','base64.standard_b64encode','base64.urlsafe_b64encode',
        'base64.b16encode',
        'base64.b32encode',
        'base64.encodestring',
	...
	#Presence of a file upload functionality
    sets.append(utils.build_conf_dict(
        'file_upload', 'B024',
        ['Flask.send_file'],
	...
	#Noise - Check if stacktrace is printed to the browser.
	sets.append(utils.build_conf_dict(
        'stacktrace', 'B004',
        ['traceback.print_tb',
        ...
        'traceback.tb_lineno'],
        'StackTrace appears to be printed.','LOW'
        ))
